...
- 🕰️ **[chronologically-you](https://github.com/shayesta19/chronologically-you)** — Enter a birthday and scroll a century of world events, each one stamped with how old you were when it happened. The events are not the point; the number beside them is, which makes the date arithmetic the whole product. Zero dependencies, no build step, and 49 tests behind the age maths — including a summers grid where the counting has more edge cases than it looks. Live at **[shayesta19.github.io/chronologically-you](https://shayesta19.github.io/chronologically-you/)**.
